 ...
 * @private
 */
function SymbolQuad(tl, tr, bl, br, tex, writingMode, glyphOffsetX, glyphOffsetY) {
    this.tl = tl;
    this.tr = tr;
    this.bl = bl;
    this.br = br;
...
function getGlyphQuads(anchor, shaping, layer, alongLine, globalProperties, featureProperties) {
    ...
    for (let k = 0; k < positionedGlyphs.length; k++) {
        ...
        quads.push(new SymbolQuad(tl, tr, bl, br, rect, shaping.writingMode, xOffset, yOffset));
    }
